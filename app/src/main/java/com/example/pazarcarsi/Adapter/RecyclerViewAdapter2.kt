...
class RecyclerViewAdapter2(val urun:ArrayList<Urun>):RecyclerView.Adapter<RecyclerViewAdapter2.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view=inflater.inflate(R.layout.item_row2,parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.view.urun.text=urun[position].urunismi
        holder.view.fiyat.text=urun[position].urunfiyat.toString()
